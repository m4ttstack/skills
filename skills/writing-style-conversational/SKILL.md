...
metadata:
  compiled: "mattstack@0.17.21"
---

<!-- compiled by rt skills compile from the sources below; slots pre-resolved; edits here are working-tree drift (rt skills promote) -->

<!-- part: step source=mattstack:writing-style-conversational version=0.17.21 path=attachments/writing-style/writing-style-conversational/SKILL.md lines=7-72 -->
