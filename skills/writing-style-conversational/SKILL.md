...
<!-- part: step source=mattstack:writing-style-conversational version=0.21.2 path=attachments/writing-style/writing-style-conversational/SKILL.md lines=7-72 -->
