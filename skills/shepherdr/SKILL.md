...
metadata:
  compiled: "mattstack@0.10.10 + mattstack:model-tiering@0.10.10 + mattstack:execution-strategy@0.10.10 + mattstack:cswap-accounts@0.10.10"
---

<!-- compiled by rt skills compile from the sources below; slots pre-resolved; edits here are working-tree drift (rt skills promote) -->

<!-- part: step source=mattstack:shepherdr version=0.10.10 path=attachments/orchestration/shepherdr/SKILL.md lines=15-421 -->
...
<!-- part: slot:tiering binding=mattstack:model-tiering version=0.10.10 path=attachments/model-tiering/SKILL.md lines=8-117 -->
# Model Tiering
...
<!-- part: slot:strategy binding=mattstack:execution-strategy version=0.10.10 path=attachments/execution-strategy/SKILL.md lines=8-90 -->
# Execution Strategy
...
<!-- part: slot:accounts binding=mattstack:cswap-accounts version=0.10.10 path=attachments/cswap-accounts/SKILL.md lines=9-74 -->
# cswap account pool
