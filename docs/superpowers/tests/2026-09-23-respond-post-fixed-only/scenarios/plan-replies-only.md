...
{"thread-1": {"value": "reply:T1", "text": "The wait is a fixed 30s delay (queue/retry.ts:14), not a backoff, so the README keeps delay."}, "thread-2": "reply:T2", "code-changes": "skip"}
