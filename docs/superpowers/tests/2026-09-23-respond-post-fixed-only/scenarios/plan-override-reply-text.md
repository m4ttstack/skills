...
{"thread-1": {"value": "reply:T1", "text": "Non-retryable jobs are rare enough here that the retry loop stays as is; the next change to the queue adds the check."}, "thread-2": "reply:T2", "code-changes": "skip"}
