...
- T3 · lib/log.ts:40 · pushback, recommended skip · gate-1: skip · reply: none
...
- T4 · queue/worker.ts:20 · valid, recommended fix · gate-1: fix · sha: c9d0e12 · reply: "Fixed -- queue/worker.ts:20 / the worker now skips paused jobs; added a test."
